...
class MigrateTotalRowDataSourceEntryCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $migratedAlertsCount = $this->migrateMultiDateTransform($output, $dataSourceEntries);
     ...
     */
    private function migrateMultiDateTransform(OutputInterface $output, array $dataSourceEntries)
    {
        $migratedCount = 0;
