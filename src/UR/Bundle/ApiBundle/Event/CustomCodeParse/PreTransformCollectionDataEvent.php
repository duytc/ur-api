...
class PreTransformCollectionDataEvent extends UrEvent
{
    protected $fileName;
     ...
     */
    public function __construct($publisherId, $connectedDataSourceId, $dataSourceId, $fileName, $fileReference, Collection &$collection, $priorModification, $dataAfterModification)
    {
